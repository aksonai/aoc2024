...
# X and page number Y are to be produced as part of an update, page number X must be
...
# update, 75,47,61,53,29, means that the update consists of page numbers 75, 47, 61,
# 53, and 29.
